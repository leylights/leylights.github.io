    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function buildTimeSeriesAnalysis(section, region, level) {
                const CASES_START = new Date('2020-01-25'), DEATHS_START = new Date('2020-03-08'), TODAY = new Date(Date.now() - Date.now() % (24 * 60 * 60 * 1000)), caseDays = Molasses.daysBetween(CASES_START, TODAY), deathsDays = Molasses.daysBetween(DEATHS_START, TODAY);
                ...
                me.createGrid(section, 'Cumulative totals', [
                    {
                        title: "Cases",
                        responseGetter: () => __awaiter(this, void 0, void 0, function* () {
                            return Molasses.numberToPrettyNumber(yield COVIDDataBridge.getSummary('cases', region.locationId, level));
                        }),
                    }, level === COVIDRegionLevel.regional ? null : {
                        title: "Hospitalizations",
                        responseGetter: () => __awaiter(this, void 0, void 0, function* () {
                            return Molasses.numberToPrettyNumber(yield COVIDDataBridge.getSummary('hospitalizations', region.locationId, level));
                        }),
                    }, {
                        title: "Deaths",
                        responseGetter: () => __awaiter(this, void 0, void 0, function* () {
                            return Molasses.numberToPrettyNumber(yield COVIDDataBridge.getSummary('deaths', region.locationId, level));
                        }),
                    }
            ...
            function buildMainRow(section, data) {
                me.createGrid(section, data.title, [{
                        ...
                        responseGetter: () => __awaiter(this, void 0, void 0, function* () {
                            return Molasses.numberToPrettyNumber(COVIDDashboardPage.getTimeSeriesAverage(yield COVIDDataBridge.getTimeSeries('cases', data.locationId, data.level), 7, true));
                        }),
                    }, {
