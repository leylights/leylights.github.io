function getCalc() {
    if (getInputElementById("quadA").value === "" ||
        getInputElementById("quadB").value === "" ||
        getInputElementById("quadC").value === "")
        return;
    let s = quadCalc(Number(getInputElementById("quadA").value), Number(getInputElementById("quadB").value), Number(getInputElementById("quadC").value));
