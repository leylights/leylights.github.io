...
function calculateAll() {
    // Error Check
    if (isNaN(parseInt(document.getElementById("re-w").value))) {
    ...
    else if (isNaN(parseInt(document.getElementById("im-w").value))) {
    ...
    else if (isNaN(parseInt(document.getElementById("re-z").value))) {
    ...
    else if (isNaN(parseInt(document.getElementById("im-z").value))) {
    ...
    let w = new complexNumber(parseInt(document.getElementById("re-w").value), parseInt(document.getElementById("im-w").value));
    let z = new complexNumber(parseInt(document.getElementById("re-z").value), parseInt(document.getElementById("im-z").value));
...
//# sourceMappingURL=oldcomplex.js.map