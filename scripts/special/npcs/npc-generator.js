...
class NPCsGenerator {
    static init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // fill race dropdown
            cws.Object.values(NPCsRace.list).forEach((race) => {
            ...
            let classNames = cws.Object.values(NPCsClass.list)
                .map(a => {
                return a.name;
            })
                .sort((a, b) => {
    ...
    static createCard(scrollTo, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // get race, class
            if (!data) {
                let races = cws.Object.values(NPCsRace.list);
                ...
                let classes = cws.Object.values(NPCsClass.list);
