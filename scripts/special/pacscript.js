...
function component(width, height, inputColour, x, y, type, extraType) {
        ...
        if (this.type == "text") {
            ...
            if (this === player && this.isDead === true) {
                switch (this.movementDirection) {
                    case "left":
                        drawRotatedImg(this.image, Math.floor(this.x), Math.floor(this.y), Math.floor(this.width), Math.floor(this.height), 270);
                        break;
                    case "down":
                        drawRotatedImg(this.image, Math.floor(this.x), Math.floor(this.y), Math.floor(this.width), Math.floor(this.height), 180);
                        break;
                    case "right":
                        drawRotatedImg(this.image, Math.floor(this.x), Math.floor(this.y), Math.floor(this.width), Math.floor(this.height), 90);
                        break;
                    default:
                        drawRotatedImg(this.image, Math.floor(this.x), Math.floor(this.y), Math.floor(this.width), Math.floor(this.height), 0);
                        break;
                }
            }
    ...
    this.newPos = function () {
        ...
        if (this.aiType == "blinky" ||
            this.aiType == "pinky" ||
            this.aiType == "clyde" ||
            this.aiType == "starting" ||
            this.aiType === "chaseAi" ||
            this.aiType === "deadGhost") {
            if (this.aiType === "chaseAi")
            ...
            switch (this.movementDirection) {
                case "up":
                    if (!this.safeUp && this.decisionTimer === 0) {
                        ...
                        else if (findDirection(this, player)[0] == "left" &&
                            this.safeLeft) {
                            this.movementDirection = "left";
                            this.speedX -= this.movementSpeed;
                        }
                        else if (this.safeRight &&
                            findDirection(this, player)[1] == "right") {
                            this.movementDirection = "right";
                            this.speedX += this.movementSpeed;
                        }
                        else if (this.safeLeft &&
                    ...
                    if (this.aiType !== "deadGhost" && this.aiType !== "chaseAi")
                        ...
                        if (this.white)
                            ...
                            this.image = sprites[5][Math.floor((currentTime % 200) / 100)];
                    }
                    else {
                ...
                case "down":
                    if (!this.safeDown && this.decisionTimer === 0) {
                        ...
                        else if (findDirection(this, player)[0] == "right" &&
                            this.safeRight) {
                            this.movementDirection = "right";
                            this.speedX += this.movementSpeed;
                        }
                ...
                case "left":
                    if (!this.safeLeft && this.decisionTimer === 0) {
                        ...
                        else if (findDirection(this, player)[0] == "down" &&
                            this.safeDown) {
                            this.movementDirection = "down";
                            this.speedY += this.movementSpeed;
                        }
...
function updateGameArea() {
    ...
    if (gameState == "game" && playerHasEntered === true) {
        ...
        else if (fruitSpawnTime + 6 === lifeElapsedTime &&
            entities[entities.length - 1] === "fruit") {
        ...
        if (currentTime - longChaseStartTime > 6000 && chaseStartTime !== 0) {
            if ((currentTime - longChaseStartTime) % 500 < 250) {
                ...
                switchColours(true);
                if (entities[entities.length - 4].aiType !== "starting" &&
                ...
                else if (entities[entities.length - 12].aiType === null &&
                    lifeElapsedTime > 10) {
                    entities[entities.length - 12].aiType = "starting";
                }
                if (entities[entities.length - 16].aiType !== "starting" &&
                ...
                else if (entities[entities.length - 16].aiType === null &&
                    lifeElapsedTime > 15) {
        ...
        if (lifeElapsedTime < 12 && chaseStartTime === 0) {
            if (lifeElapsedTime > 1 &&
                Math.random() < 0.02 &&
                entities[entities.length - 12].aiType === null) {
                entities[entities.length - 12].aiType = "starting";
            }
            else if (lifeElapsedTime > 3 &&
                Math.random() < 0.02 &&
                entities[entities.length - 8].aiType === null &&
                entities[entities.length - 12].aiType !== null) {
                entities[entities.length - 8].aiType = "starting";
            }
            else if (lifeElapsedTime > 5 &&
                Math.random() < 0.02 &&
                entities[entities.length - 4].aiType === null &&
                entities[entities.length - 8].aiType !== null) {
                entities[entities.length - 4].aiType = "starting";
        ...
        for (var e = 0; e < entities.length; e += 2) {
            ...
            if (entities[e + 1] === "ghost" || entities[e + 1] === "margin") {
                ...
                else if (entities[e].name === "clyde" &&
                    entities[e].aiType !== null &&
                    entities[e].aiType !== "starting" &&
                    entities[e].aiType !== "chaseAi" &&
                    entities[e].aiType !== "deadGhost") {
                    if (Math.abs(entities[e].x - player.x) < 50 ||
            ...
            if (entities[e].isMargin) {
                ...
                for (var w2 = 0; w2 < walls.length; w2 += 2) {
                    ...
                    if (entityCollisionDataWalls[0] === true &&
                        player.isDead === false &&
                        walls[w2 + 1] !== "slow") {
                    ...
                    else if (entityCollisionDataWalls[0] === true &&
                        walls[w2 + 1] === "slow") {
                    ...
                    else if (!entities[e].margining.isSlowed &&
                        entities[e].margining.aiType != "deadGhost" &&
                        chaseStartTime === 0) {
        ...
        if (player.isDead) {
            if (player.timer < 5)
                ...
                if (lives - 1 > 0) {
                    ...
                    if (document.getElementById("usernameBox") === null &&
                    ...
                    if (document.getElementById("usernameBox") === null &&
                        ...
                        button.setAttributeNode(betterCreateAttr("onclick", "buttonInput()"));
...
// 448, 576
function mainMenu() {
    rect(Math.ceil(gameBox.canvas.width / 10), Math.ceil(gameBox.canvas.height / 10), Math.ceil(gameBox.canvas.width * 0.8), Math.ceil(gameBox.canvas.height * 0.8), "blue");
    rect(Math.ceil(gameBox.canvas.width / 8), Math.ceil(gameBox.canvas.height / 8), Math.ceil(gameBox.canvas.width * 0.75), Math.ceil(gameBox.canvas.height * 0.75), "black");
    drawText("PAC MAN", gameBox.canvas.width / 2, 170, "yellow", true, 60, "Courier New");
    drawImg(sprites[0][9 + Math.ceil((currentTime % 1000) / 250) % 4], gameBox.canvas.width / 2 - 100, 200, 200, 200);
    drawText("Use W A S D or Arrow", gameBox.canvas.width / 2, 455, "yellow", true, 24, "Courier New");
    drawText("Keys to Play", gameBox.canvas.width / 2, 485, "yellow", true);
    if (gameBox.keys && (gameBox.keys[87] || gameBox.keys[38]))
        pressed[0] = true;
    if (gameBox.keys && (gameBox.keys[65] || gameBox.keys[39]))
        pressed[1] = true;
    if (gameBox.keys && (gameBox.keys[83] || gameBox.keys[37]))
        pressed[2] = true;
    if (gameBox.keys && (gameBox.keys[68] || gameBox.keys[40]))
        pressed[3] = true;
...
function drawText(text, x, y, colour, centered, size, type) {
    gameBox.context.fillStyle = colour;
    if (type != null)
        gameBox.context.font = size + "px " + type;
    if (centered)
        gameBox.context.textAlign = "center";
    else
        gameBox.context.textAlign = "left";
    gameBox.context.fillText(text, x, y);
}
function drawImg(img, x, y, w, h) {
    if (h === null)
        gameBox.context.drawImage(img, x, y);
    else
        gameBox.context.drawImage(img, x, y, w, h);
}
function drawRotatedImg(img, x, y, w, h, angle) {
    ...
    if (h === null)
        ...
        gameBox.context.drawImage(img, -w / 2, -h / 2, w, h);
    gameBox.context.rotate(-angle * (Math.PI / 180));
    gameBox.context.translate(-x - img.width / 2, -y - img.height / 2);
}
...
function switchColours(final) {
    ...
    if (entities[entities.length - 4].aiType === "chaseAi") {
        if (entities[entities.length - 4].image === sprites[5][0] ||
...
function playerGhostCollision(e) {
    if (entities[e + 1] !== "ghost") {
        ...
        entities[e + 1] === "ghost" &&
        !godMode) {
        if (Math.sqrt(Math.pow(Math.abs(entities[e].x - player.x), 2) +
            Math.pow(Math.abs(entities[e].y - player.y), 2)) < 28) {
            player.isDead = true;
            gameState = "next";
        }
    }
...
function findDirection(me, it) {
    ...
    if (me.aiType === "clyde" ||
        ...
        if ((Math.abs(verticalResult) < 50 || Math.abs(horizontalResult) < 50) &&
            me.aiType === "clyde") {
            me.aiType = "blinky";
        }
        else if (Math.abs(verticalResult) < 10 &&
...
function createEntity(w, h, colour, xInput, yInput, type) {
    if (colour === "white") {
        ...
        entities.push(new component(w, h, colour, xInput, yInput, "entity", "image"));
    }
    if (type === "ghost") {
...
function createMap() {
    ...
    playerMargin = new component(30, 32, "white", player.x + 1, player.y, "entity");
    ...
    for (var i = 0; i < 6; i++) {
        // top left column
        if (i == 1)
            createEntity(16, 16, murderImg, 16, 96, "murderPellet");
        else if (i == 3)
            continue;
        else
            createEntity(4, 4, "white", 22, 86 + i * 16, "normalPellet");
    }
    for (var i = 0; i < 6; i++) {
        // top right column
        if (i == 1)
        ...
        // createEntity(16, 16, murderImg, 416, 96, "murderPellet", "image");
            ...
            createEntity(4, 4, "white", 422, 86 + i * 16, "normalPellet");
    }
    for (var i = 0; i < 8; i++) {
        // bottom left column
        if (i == 2) {
...
function highScoreEntry() {
    rect(Math.ceil(gameBox.canvas.width / 10), Math.ceil(gameBox.canvas.height / 10), Math.ceil(gameBox.canvas.width * 0.8), Math.ceil(gameBox.canvas.height * 0.8), "blue");
    rect(Math.ceil(gameBox.canvas.width / 8), Math.ceil(gameBox.canvas.height / 8), Math.ceil(gameBox.canvas.width * 0.75), Math.ceil(gameBox.canvas.height * 0.75), "black");
    drawText("HIGH SCORE", gameBox.canvas.width / 2, 140, "yellow", true, 48, "Courier New");
    drawText("DETECTED", gameBox.canvas.width / 2, 190, "yellow", true, 48, "Courier New");
    drawText("PLEASE ENTER A NAME", gameBox.canvas.width / 2, 260, "yellow", true, 28, "Courier New");
    drawText("AT THE SIDE", gameBox.canvas.width / 2, 290, "yellow", true, 24, "Courier New");
    drawText("OF THE SCREEN", gameBox.canvas.width / 2, 320, "yellow", true, 24, "Courier New");
}
// HIGH SCORES
if (typeof Storage !== "undefined") {
    var numOfScores;
    if (localStorage.getItem("numOfScores") !== null &&
...
function buttonInput() {
    scorePause = false;
    addHighScore(document.getElementById("usernameBox").value.toUpperCase(), score);
}
...
//# sourceMappingURL=pacscript.js.map