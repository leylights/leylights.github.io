...
export class Leylights {
    ...
    static createElement(data) {
        ...
        if (data.style)
            element.setAttributeNode(Leylights.betterCreateAttr('style', data.style));
        if (data.innerHTML)
    ...
    static createTable(data) {
        ...
        if (data.head)
            contents.push(Leylights.createElement({
                type: 'thead',
...
Leylights.betterCreateAttr = function (type, value) {
...
/**
   ...
   * @deprecated use Canvas object instead
 */
Leylights.drawImg = function (img, x, y, w, h, surface) {
 ...
 * @deprecated use Canvas object instead
 */
Leylights.drawLine = function (x1, y1, x2, y2, colour, width, surface) {
    surface.beginPath();
 ...
 * @deprecated use Canvas object instead
 */
Leylights.drawText = function (text, x, y, colour, centered, size, type, surface) {
    surface.fillStyle = colour;
    if (size !== null) {
 ...
 * @deprecated use Canvas object instead
 */
Leylights.fillCircle = function (x, y, r, colour, centered, surface) {
    surface.beginPath();
    if (centered) {
 ...
 * @deprecated use Canvas object instead
 */
Leylights.fillTriangle = function (x, y, w, h, colour, center, angle, canvas) {
    const ctx = canvas;
 ...
 */
Leylights.getInputElementById = function (id) {
 ...
 */
Leylights.toCamelCase = function (str) {
 ...
 */
Leylights.toCapitalized = function (str) {
 ...
 */
Leylights.toRadians = function (degreeValue) {
...
//# sourceMappingURL=leylights.js.map