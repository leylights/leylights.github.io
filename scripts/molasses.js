...
export class Molasses {
    ...
    static createTable(data) {
        ...
        if (data.head)
            contents.push(Molasses.createElement({
                type: 'thead',
...
Molasses.betterCreateAttr = function (type, value) {
...
/**
   ...
   * @deprecated use Canvas object instead
 */
Molasses.drawImg = function (img, x, y, w, h, surface) {
 ...
 * @deprecated use Canvas object instead
 */
Molasses.drawLine = function (x1, y1, x2, y2, colour, width, surface) {
    surface.beginPath();
 ...
 * @deprecated use Canvas object instead
 */
Molasses.drawText = function (text, x, y, colour, centered, size, type, surface) {
    surface.fillStyle = colour;
    if (size !== null) {
 ...
 * @deprecated use Canvas object instead
 */
Molasses.fillCircle = function (x, y, r, colour, centered, surface) {
    surface.beginPath();
    if (centered) {
 ...
 * @deprecated use Canvas object instead
 */
Molasses.fillTriangle = function (x, y, w, h, colour, center, angle, canvas) {
    const ctx = canvas;
 ...
 */
Molasses.getInputElementById = function (id) {
 ...
 */
Molasses.toCamelCase = function (str) {
 ...
 */
Molasses.toCapitalized = function (str) {
 ...
 */
Molasses.toRadians = function (degreeValue) {
    return degreeValue * (Math.PI / 180);
};
Molasses.toTitleCase = function (str) {
    if (!str)
        return str;
...
//# sourceMappingURL=molasses.js.map