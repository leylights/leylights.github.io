...
export class NPCsInitiativeTracker {
  ...
  resetCurrentRoundHTML(this: NPCsInitiativeTracker) {
    const me = this,
      lastRound: number = cws.parseFirstFloat(this.HTML.tracker.currentRound.innerText);
