...
class NPCsGenerator {
  ...
  static async init(): Promise<void> {
    ...
    Molasses.Object.values(NPCsRace.list).forEach((race: NPCsRace) => {
    ...
    let classNames: string[] = Molasses.Object.values(NPCsClass.list)
      .map(a => {
        return a.name;
      })
  ...
  static async createCard(scrollTo?: 'card' | 'top' | null, data?: NPCsCharacterData): Promise<void> {
    ...
    // get race, class
    if (!data) {
      let races: NPCsRace[] = Molasses.Object.values(NPCsRace.list);
      ...
      let classes: NPCsClass[] = Molasses.Object.values(NPCsClass.list);
