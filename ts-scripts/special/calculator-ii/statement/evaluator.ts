...
export class CalculatorEvaluator extends CalculatorComponent {
      ...
      if (lhs instanceof CalculatorValue && rhs instanceof CalculatorValue) {
        switch (input.operator) {
          ...
          case CalculatorOperator.divide: {
            if (rhs.value.isEqualTo(MathNum.ZERO)) throw new CalculatorError(CalculatorErrorType.divisionByZero, `${lhs.value} / ${rhs.value}`);
   ...
   */
  static simplify(input: CalculatorTerm): CalculatorTerm {
