...
export class ResumePage {
  ...
  private static loadExperience(): void {
    ...
    ResumePage.experienceItems.push(
      new ResumeOccupationItemComponent({
  ...
  private static loadProjects(): void {
    ...
    ResumePage.projects.push(
      new ResumeExperienceItemComponent({
    ...
    ResumePage.smallProjects.push(
      new ResumeSmallExperienceItem({
        title: "Wordlebot",
        dates: ["Summer 2022"],
  ...
  private static loadSkills(): void {
    ...
    skillInfo.forEach((info) => {
      ResumePage.skills.push(
        new ResumeSkillComponent(skillParent, info[0], {
